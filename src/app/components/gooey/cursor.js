...
export class GooCursor {
    ...
    getCellAtCursor() {
        ...
        const cellAtCursor = this.DOM.cells[cellIndex];
        const cellIndexDebug = [...this.DOM.cells].indexOf(cellAtCursor);
        // console.log('Cell at cursor:', cellAtCursor);
        // console.log('Cell index:', cellIndexDebug);
